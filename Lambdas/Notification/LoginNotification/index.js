...
exports.handler = async (event) => {
  try {
    // const email = event.request.userAttributes.email; // Assuming email is part of userAttributes
    // const userId = event.request.userAttributes.sub; // Assuming sub is used as userId
    ...
    throw err; // Rethrow the error to handle it properly
  }
};
